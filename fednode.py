...
REPOS_FULL = REPOS_ASPIREBLOCK + ['aspirewallet', 'aspire-scout'] # , 'armory-utxsvr']

HOST_PORTS_USED = {
    'base': [9874, 19874, 4000, 14000],
    'aspireblock': [9874, 19874, 4000, 14000, 4100, 14100, 27017],
    'full': [9874, 19874, 4000, 14000, 4100, 14100, 80, 443, 27017, 8182, 8183],
}

VOLUMES_USED = {
    'base': ['gasp-data', 'aspire-data'],
    'aspireblock': ['gasp-data', 'aspire-data', 'aspireblock-data', 'mongodb-data'],
    'full': ['gasp-data', 'aspire-data', 'aspireblock-data', 'mongodb-data'] # , 'armory-data']
}
...
SHELL_CHOICES = UPDATE_CHOICES + ['mongodb', 'redis', 'gasp', 'gasp-testnet', 'aspire-scout', 'aspire-scout-testnet']
    ...
    if args.command == 'install':
        ...
        for repo in REPOS:
            ...
            if not os.path.exists(repo_dir):
                git_cmd = "git clone -b {} {} {}".format(real_branch, repo_url, repo_dir)
        ...
        while services_to_update:
            ...
            if service_base not in git_has_updated:
                ...
                for service_dir in service_dirs:
                    ...
                    if service_base in ('aspire', 'aspireblock', 'armory-utxsvr'):
